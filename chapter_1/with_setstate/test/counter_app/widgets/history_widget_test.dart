...
void main() {
  group('Testing the HistoryWidget widget', () {
    testWidgets('Making sure that the widget is rendered', (tester) async {
      ...
      // Golden
      await expectLater(find.byType(HistoryWidget), matchesGoldenFile('history_widget_empty.png'),);
    });
    ...
    testWidgets('Making sure that values are displayed', (tester) async {
      ...
      // Golden
      await expectLater(find.byType(HistoryWidget), matchesGoldenFile('history_widget_data.png'),);
